...
describe('index.js Component Tests', () => {
  ...
  describe('transformJobsForSOLR', () => {
    ...
    it('should keep company uppercase', () => {
      const payload = {
        ...
        cif: '47473595',
        jobs: [
          { url: 'https://test.com/1', title: 'Job 1', company: 'gusturi divine', cif: '47473595' }
        ]
      };
  ...
  describe('mapToJobModel', () => {
    it('should map raw job to job model format', () => {
      ...
      const COMPANY_NAME = 'GUSTURI DIVINE S.R.L.';
      const COMPANY_CIF = '47473595';
    ...
    it('should remove undefined fields', () => {
      ...
      const result = index.mapToJobModel(rawJob, '47473595');
